<template>
  <div class="m-8">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to W AND K TECHNOLOGY LLC, 16-2066 Sandalwood
          Dr, Pahoa, HI 96778.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to W and K Technology, accessible from
          <a
            href="https://www.808event.com"
    ...
    <ul>
      <li>
        <p>By email: support@808event.com</p>
      </li>
      <li>
        <p>
          By mail: 15-2714 Pahoa Village Rd #336, Pahoa HI 96778, United States
        </p>
      </li>
    </ul>
  </div>
